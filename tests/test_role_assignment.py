...
def test_learn_weighted_synergy_graph_2():
	...
	and check what the model thinks is the best role assignment
	...
	set_size_list_of_lists = [[30,59,117,175,233,291,1159,2021], [30,59,117,175,233,291,1159,2025], [30,59,117,175,233,291,1157,2023], [30,59,117,175,233,291,1159,2024], [30,59,117,175,233,291,1158,2029], [30,59,117,175,233,291,1160,2024], [30,59,117,175,233,291,1161,2024]]
	true_size_list = [30,50,100,150,200,250,1000,2000]
